...
import { BellIcon, MagnifyingGlassIcon, ChevronDownIcon, ArrowRightOnRectangleIcon, Bars3Icon } from '@heroicons/react/24/solid';
...
const Header = ({ onToggleSidebar }: HeaderProps) => {
  ...
  return (
    <header className="fixed top-0 right-0 left-0 md:left-64 bg-white border-b border-gray-200 z-50">
              ...
              <MenuItem>
                {({ active }) => (
                  <button
                    ...
                    className={`${active ? 'bg-gray-100' : ''} flex items-center gap-2 w-full px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 transition-colors`}
                  >
